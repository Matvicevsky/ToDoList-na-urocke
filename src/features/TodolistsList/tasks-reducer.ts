...
export const addTaskTC = (title: string, todolistId: string) => (dispatch: Dispatch<ActionsType | SetAppStatusACType | SetAppErrorACType | ChangeTodolistEntityStatusActionType>) => {
    dispatch(setAppStatusAC('loading'))
